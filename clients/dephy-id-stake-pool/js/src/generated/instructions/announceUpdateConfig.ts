...
import {
  ...
  type StakePoolUpdatableConfig,
  type StakePoolUpdatableConfigArgs,
} from '../types';
...
export type AnnounceUpdateConfigInstructionDataArgs = {
  config: StakePoolUpdatableConfigArgs;
};
...
export function getAnnounceUpdateConfigInstructionDataEncoder(): Encoder<AnnounceUpdateConfigInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['config', getStakePoolUpdatableConfigEncoder()],
    ]),
    (value) => ({
      ...value,
...
export function getAnnounceUpdateConfigInstructionDataDecoder(): Decoder<AnnounceUpdateConfigInstructionData> {
  return getStructDecoder([
    ...
    ['config', getStakePoolUpdatableConfigDecoder()],
  ]);
}
...
> = {
  ...
  config: AnnounceUpdateConfigInstructionDataArgs['config'];
};
