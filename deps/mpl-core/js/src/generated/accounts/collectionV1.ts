...
export const COLLECTION_V1_KEY = Key.CollectionV1;

export function getCollectionV1KeyBytes() {
  return getKeyEncoder().encode(COLLECTION_V1_KEY);
}
...
export function getCollectionV1Encoder(): Encoder<CollectionV1Args> {
  return transformEncoder(
    ...
    (value) => ({ ...value, key: COLLECTION_V1_KEY })
  );
}
