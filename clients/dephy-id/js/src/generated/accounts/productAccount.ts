...
export function getProductAccountEncoder(): FixedSizeEncoder<ProductAccountArgs> {
...
export function getProductAccountDecoder(): FixedSizeDecoder<ProductAccount> {
...
export function getProductAccountCodec(): FixedSizeCodec<
  ProductAccountArgs,
  ProductAccount
> {
