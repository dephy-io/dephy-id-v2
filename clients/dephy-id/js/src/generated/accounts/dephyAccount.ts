...
export function getDephyAccountEncoder(): FixedSizeEncoder<DephyAccountArgs> {
...
export function getDephyAccountDecoder(): FixedSizeDecoder<DephyAccount> {
...
export function getDephyAccountCodec(): FixedSizeCodec<
  DephyAccountArgs,
  DephyAccount
> {
