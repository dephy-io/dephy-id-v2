...
impl CreateV1 {
    pub fn instruction(&self, args: CreateV1InstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.asset, true));
        ...
        if let Some(owner) = self.owner {
            accounts.push(solana_instruction::AccountMeta::new_readonly(owner, false));
        } else {
            accounts.push(solana_instruction::AccountMeta::new_readonly(
                crate::MPL_CORE_ID,
                false,
...
impl CreateV1Builder {
    ...
    /// The owner of the new asset. Defaults to the authority if not present.
    #[inline(always)]
    pub fn owner(&mut self, owner: Option<solana_pubkey::Pubkey>) -> &mut Self {
        self.owner = owner;
        self
    }
    /// `[optional account]`
...
pub struct CreateV1CpiAccounts<'a, 'b> {
    ...
    /// The owner of the new asset. Defaults to the authority if not present.
    pub owner: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// The authority on the new asset
    pub update_authority: Option<&'b solana_account_info::AccountInfo<'a>>,
    /// The system program
...
impl<'a, 'b> CreateV1Cpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        let mut accounts = Vec::with_capacity(8 + remaining_accounts.len());
        accounts.push(solana_instruction::AccountMeta::new(*self.asset.key, true));
        if let Some(collection) = self.collection {
...
impl<'a, 'b> CreateV1CpiBuilder<'a, 'b> {
    ...
    /// The owner of the new asset. Defaults to the authority if not present.
    #[inline(always)]
    pub fn owner(&mut self, owner: Option<&'b solana_account_info::AccountInfo<'a>>) -> &mut Self {
