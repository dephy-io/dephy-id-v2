...
pub const WRITE_COLLECTION_EXTERNAL_PLUGIN_ADAPTER_DATA_V1_DISCRIMINATOR: u8 = 29;
...
impl WriteCollectionExternalPluginAdapterDataV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(buffer) = self.buffer {
            accounts.push(solana_instruction::AccountMeta::new_readonly(buffer, false));
        } else {
            accounts.push(solana_instruction::AccountMeta::new_readonly(
                crate::MPL_CORE_ID,
                false,
...
impl Default for WriteCollectionExternalPluginAdapterDataV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
