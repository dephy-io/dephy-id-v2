...
export const REDEEM_WITHDRAW_DISCRIMINATOR = new Uint8Array([
  207, 106, 55, 85, 39, 199, 151, 142,
]);

export function getRedeemWithdrawDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REDEEM_WITHDRAW_DISCRIMINATOR
  );
}

export type RedeemWithdrawInstruction<
...
export type RedeemWithdrawInstructionData = {
  discriminator: ReadonlyUint8Array;
  amount: bigint;
};

export type RedeemWithdrawInstructionDataArgs = { amount: number | bigint };

export function getRedeemWithdrawInstructionDataEncoder(): Encoder<RedeemWithdrawInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['amount', getU64Encoder()],
    ]),
    (value) => ({ ...value, discriminator: REDEEM_WITHDRAW_DISCRIMINATOR })
  );
}

export function getRedeemWithdrawInstructionDataDecoder(): Decoder<RedeemWithdrawInstructionData> {
...
export function getRedeemWithdrawInstructionDataCodec(): Codec<
  RedeemWithdrawInstructionDataArgs,
  RedeemWithdrawInstructionData
> {
  return combineCodec(
    getRedeemWithdrawInstructionDataEncoder(),
    getRedeemWithdrawInstructionDataDecoder()
  );
}

export type RedeemWithdrawAsyncInput<
...
> = {
  ...
  amount: RedeemWithdrawInstructionDataArgs['amount'];
};

export async function getRedeemWithdrawInstructionAsync<
  TAccountStakePool extends string,
  TAccountUser extends string,
  TAccountUserStakeAccount extends string,
  TAccountWithdrawRequest extends string,
...
>(
  input: RedeemWithdrawAsyncInput<
    TAccountStakePool,
    TAccountUser,
    TAccountUserStakeAccount,
    TAccountWithdrawRequest,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getRedeemWithdrawInstructionDataEncoder().encode(
      args as RedeemWithdrawInstructionDataArgs
    ),
  } as RedeemWithdrawInstruction<
    TProgramAddress,
    TAccountStakePool,
    TAccountUser,
    TAccountUserStakeAccount,
...
export type RedeemWithdrawInput<
  TAccountStakePool extends string = string,
  TAccountUser extends string = string,
  TAccountUserStakeAccount extends string = string,
  TAccountWithdrawRequest extends string = string,
...
export function getRedeemWithdrawInstruction<
  TAccountStakePool extends string,
  TAccountUser extends string,
  TAccountUserStakeAccount extends string,
  TAccountWithdrawRequest extends string,
...
export type ParsedRedeemWithdrawInstruction<
  TProgram extends string = typeof DEPHY_ID_STAKE_POOL_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RedeemWithdrawInstructionData;
};

export function parseRedeemWithdrawInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedRedeemWithdrawInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRedeemWithdrawInstructionDataDecoder().decode(instruction.data),
  };
}
