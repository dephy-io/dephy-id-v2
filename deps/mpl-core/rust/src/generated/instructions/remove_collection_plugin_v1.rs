...
pub const REMOVE_COLLECTION_PLUGIN_V1_DISCRIMINATOR: u8 = 5;
...
impl Default for RemoveCollectionPluginV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
impl RemoveCollectionPluginV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
...
impl<'a, 'b> RemoveCollectionPluginV1Cpi<'a, 'b> {
    pub fn new(
...
impl<'a, 'b> RemoveCollectionPluginV1CpiBuilder<'a, 'b> {
