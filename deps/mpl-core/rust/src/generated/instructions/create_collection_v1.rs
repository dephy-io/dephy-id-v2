...
impl CreateCollectionV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&CreateCollectionV1InstructionData::new()).unwrap();
...
impl Default for CreateCollectionV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
impl CreateCollectionV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the new asset
...
impl<'a, 'b> CreateCollectionV1Cpi<'a, 'b> {
    pub fn new(
