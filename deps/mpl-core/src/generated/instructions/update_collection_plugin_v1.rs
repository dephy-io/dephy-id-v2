...
impl UpdateCollectionPluginV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&UpdateCollectionPluginV1InstructionData::new()).unwrap();
...
impl Default for UpdateCollectionPluginV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
impl UpdateCollectionPluginV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
...
impl<'a, 'b> UpdateCollectionPluginV1Cpi<'a, 'b> {
    pub fn new(
...
impl<'a, 'b> UpdateCollectionPluginV1CpiBuilder<'a, 'b> {
