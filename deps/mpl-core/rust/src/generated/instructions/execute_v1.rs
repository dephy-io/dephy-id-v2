...
impl ExecuteV1 {
    pub fn instruction(&self, args: ExecuteV1InstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ExecuteV1InstructionData::new()).unwrap();
...
impl Default for ExecuteV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct ExecuteV1Builder {
    ...
    asset_signer: Option<solana_pubkey::Pubkey>,
...
impl ExecuteV1Builder {
    ...
    /// The signing PDA for the asset
    #[inline(always)]
    pub fn asset_signer(&mut self, asset_signer: solana_pubkey::Pubkey) -> &mut Self {
...
pub struct ExecuteV1CpiAccounts<'a, 'b> {
    ...
    /// The signing PDA for the asset
    pub asset_signer: &'b solana_account_info::AccountInfo<'a>,
    /// The account paying for the storage fees
...
impl<'a, 'b> ExecuteV1CpiBuilder<'a, 'b> {
    ...
    pub fn asset_signer(
        &mut self,
        asset_signer: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct ExecuteV1CpiBuilderInstruction<'a, 'b> {
    ...
    collection: Option<&'b solana_account_info::AccountInfo<'a>>,
    asset_signer: Option<&'b solana_account_info::AccountInfo<'a>>,
